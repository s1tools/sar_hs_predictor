...
import pickle
import s1tools
from s1tools.sarhspredictor.predict_hs_from_wv_ocn_cartesian_xspec import get_Hs_inference_from_CartesianXspectra
import numpy as np
...
def test_hs_predictions_before_WV2_EAP():
    ...
    input_test_dataset = os.path.join(os.path.dirname(s1tools.sarhspredictor.__file__),'referencedata',
    'S1A_WV_OCN__2SSV_20231003T122250_20231003T124111_050600_061886_3197.SAFE','measurement','s1a-wv2-ocn-vv-20231003t122403-20231003t122406-050600-061886-006.nc')
